         ...
         <div class="margin">
            ...
            <div class="s-12 l-9">
               ...
               <article class="margin-bottom">
                  ...
                  <!-- text -->                 
                  <div class="post-text">
                     <h1>Early Childhood Initiatives</h1>
                     <p>
                     ...
                     <h3>Early Childhood Initiatives</h3>
                     <p>
                        The Braille Reading Pals Club introduces young blind children and their families to literacy through Braille. The program fosters positive attitudes about Braille and helps sighted family members promote a love of reading through the shared reading of print/Braille books with their blind children. This program is designed for blind and low-vision children ages birth through eight years old. .
                     </p>
            ...
            <div class="s-12 l-3">
               <aside>
                  ...
                  <div class="aside-block margin-bottom">
                     <h3>Early Childhood Initiatives</h3>
                     <p>The National Federation of the Blind National Convention is the largest gathering of blind people in the world. It is the premier event for training, support, and information for the blind community. It also serves as a governing body, democratically electing our leadership and establishing each year's organizational priorities.</p>
                  </div>
                  <!-- AD REGION --> 
                  ...
                  <div class="aside-block margin-bottom">
                     ...
                     <a class="latest-posts" href="post-1.html">
                        <h5>Early Childhood Initiatives</h5>
                        <p>
                     ...
                     <a class="latest-posts" href="post-3.html">
                        <h5>NEarly Childhood Initiatives</h5>
                        <p>
